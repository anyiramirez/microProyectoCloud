...
sudo cp -r /vagrant/Consul_N1/Consul_exec_services/consulN1.service /etc/systemd/system/

echo -e "\n\n copying Instance1 service file into /etc/systemd/system/ route"
sudo cp -r /vagrant/Consul_N1/Consul_exec_services/instance_con_1.service /etc/systemd/system/

echo -e "\n\n copying Instance1 service file into /etc/systemd/system/ route"
sudo cp -r /vagrant/Consul_N1/Consul_exec_services/instance_con_2.service /etc/systemd/system/
...
sudo systemctl enable consulN1
...
sudo systemctl start consulN1

echo -e "Checking Consul status"
sudo systemctl status consulN1
#----------------------------------------------------------------------------------
...
sudo cp -r /vagrant/Consul_N1/app_index/index.js $install_dir
